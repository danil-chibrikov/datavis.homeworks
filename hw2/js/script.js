...
let xParam = 'population';
let yParam = 'population';
let radius = 'population';
let year = '2000';
...
d3.select('#radius')
  ...
  .attr("selected", function(elem) {if (elem == xParam) return true;});
...
d3.select('#y')
  ...
  .attr("selected", function(elem) {if (elem == yParam) return true;});
